...
public class CustomUserDetailsService implements UserDetailsService
{
    ...
    public UserDetails loadUserByUsername(final String login) throws UsernameNotFoundException {
        final com.farouk.bengarssallah.java.spring.security.annotation.domain.User user = this.userService.findByLogin(login);
        if (user == null) {
    ...
    private List<GrantedAuthority> getGrantedAuthorities(final com.farouk.bengarssallah.java.spring.security.annotation.domain.User user) {
